...
# ---------------------- Multimodal Classifier (No Cross Attention) ----------------------
...
def extract_features(model, spectra, descriptions, tokenizer, device, batch_size=128, labels=None):
    model.eval()
    features_list = []
    labels_list = []
...
# ---------------------- Plot UMAP Visualizations (with Jitter) ----------------------
...
ax1.set_title("UMAP Before Training (VGGNet, No Cross Attention)")
ax1.set_xlabel("UMAP Component 1")
ax1.set_ylabel("UMAP Component 2")

# Post-training
scatter2 = ax2.scatter(post_train_umap_features_jittered[:, 0], post_train_umap_features_jittered[:, 1], c=post_train_labels, cmap='tab20', s=10, alpha=0.3)
ax2.set_title("UMAP After Training (VGGNet, No Cross Attention)")
...
plt.savefig("VGGNet_umap_comparison_before_after_training_no_cross_attention_jittered.png", bbox_inches='tight')
plt.show()
...
scatter1 = ax1.scatter(sub_pre_train_umap_features[:, 0], sub_pre_train_umap_features[:, 1], c=sub_pre_train_labels, cmap='tab20', s=50, alpha=0.6)
ax1.set_title("UMAP Before Training (VGGNet, Subsampled, No Cross Attention)")
ax1.set_xlabel("UMAP Component 1")
ax1.set_ylabel("UMAP Component 2")
...
ax2.set_title("UMAP After Training (VGGNet, Subsampled, No Cross Attention)")
ax2.set_xlabel("UMAP Component 1")
ax2.set_ylabel("UMAP Component 2")
...
plt.savefig("VGGNet_umap_comparison_before_after_training_no_cross_attention_subsampled.png", bbox_inches='tight')
plt.show()
...
plt.title("Confusion Matrix on Test Set (VGGNet, No Cross Attention)")
plt.xlabel("Predicted Labels")
plt.ylabel("True Labels")
plt.savefig("confusion_matrix_top20_no_cross_attention_VGGNet.png", bbox_inches='tight')
plt.show()