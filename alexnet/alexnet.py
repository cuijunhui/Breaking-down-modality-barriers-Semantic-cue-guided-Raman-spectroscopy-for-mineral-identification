...
plt.title("Average Confusion Matrix Across 5 Folds (AlexNet)")
plt.xlabel("Predicted Labels")
plt.ylabel("True Labels")
plt.savefig("average_confusion_matrix_alexnet_5fold.png", bbox_inches='tight')
plt.show()
...
ax.set_title(f"UMAP After Training (AlexNet, Best Fold {best_fold})")
...
plt.savefig(f"AlexNet_umap_best_fold_{best_fold}.png", bbox_inches='tight')
plt.show()
...
cbar.set_ticklabels(label_encoder.classes_)
cbar.ax.tick_params(rotation=45, labelsize=10)
plt.savefig(f"AlexNet_umap_with_synthetic_text_best_fold_{best_fold}.png", bbox_inches='tight')
plt.show()
