...
plt.title("Average Confusion Matrix Across 5 Folds (AlexNet+Bert)")
plt.xlabel("Predicted Labels")
plt.ylabel("True Labels")
plt.savefig("average_confusion_matrix_alexnet_bert_5fold.png", bbox_inches='tight')
plt.show()
...
jitter = 0.5
best_post_train_umap_features_jittered = best_post_train_umap_features + np.random.normal(0, jitter,
                                                                                          best_post_train_umap_features.shape)
scatter = ax.scatter(best_post_train_umap_features_jittered[:, 0], best_post_train_umap_features_jittered[:, 1],
                     c=best_post_train_labels, cmap='tab20', s=10, alpha=0.3)
...
cbar.ax.tick_params(rotation=45, labelsize=14)
plt.savefig(f"AlexNet_bert_umap_best_fold_{best_fold}.png", bbox_inches='tight',dpi=1200)
plt.show()
