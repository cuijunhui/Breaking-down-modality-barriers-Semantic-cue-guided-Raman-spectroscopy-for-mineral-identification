...
ax1.set_title("UMAP Before Training (GoogLeNet)")
...
ax2.set_title("UMAP After Training (GoogLeNet)")
...
plt.savefig("GoogLeNet_umap_comparison_before_after_training_no_kronecker_jittered.png", bbox_inches='tight')
plt.show()
...
ax1.set_title("UMAP Before Training (GoogLeNet, Subsampled)")
ax1.set_xlabel("UMAP Component 1")
ax1.set_ylabel("UMAP Component 2")
...
ax2.set_title("UMAP After Training (GoogLeNet, Subsampled)")
ax2.set_xlabel("UMAP Component 1")
ax2.set_ylabel("UMAP Component 2")
...
plt.savefig("GoogLeNet_umap_comparison_before_after_training_no_kronecker_subsampled.png", bbox_inches='tight')
plt.show()
...
plt.title("Confusion Matrix on Test Set (GoogLeNet)")
plt.xlabel("Predicted Labels")
plt.ylabel("True Labels")
plt.savefig("confusion_matrix_top20_fusion_no_kronecker_googlenet_UMP.png", bbox_inches='tight')
plt.show()